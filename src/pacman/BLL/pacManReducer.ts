...
let pacManReducer = (state: any = initState, action: any) => {
    switch (action.type) {
        case SET_DIRECTION:
            return {
                ...state,
...
export const setPacManPosition = (x: any, y: any) => ({type: SET_PAC_MAN_POSITION, x, y})
export const setDirection = (direction: any) => ({type: SET_DIRECTION, direction})
export const setGameStart = () => ({type: SET_GAME_START})

export const startMove = () => (dispatch: any, getState: any) => {
